...
public class XmlBeanDefinitionReader extends AbstractBeanDefinitionReader {
	 ...
	 * @return the number of bean definitions found
	 * @throws BeanDefinitionStoreException in case of loading or parsing errors
	 * // 核心部分【doLoadBeanDefinitions】终于到底了
	 */
	public int loadBeanDefinitions(EncodedResource encodedResource) throws BeanDefinitionStoreException {
		...
		//resourcesCurrentlyBeingLoaded用一个 ThreadLocal 来存放所有的配置文件资源，比如encode编码信息
		//通过threadlocal上下传递，下面的程序可以取到这些配置
		...
		//// 3.拿到Resource的inputStream (xml信息的读取..................)
		try (InputStream inputStream = encodedResource.getResource().getInputStream()) {
			...
			//** 5.加载 bean 定义（核心部分,do.....!!!, 方法以do开头，真正处理的方法）
